...
export const nodeSchema = z.object({
  ...
  entity_type: z
    .string()
    .describe(
      "The type of the node. For example: PERSON, COMPANY, CONCEPT",
    ),
  attributes: z
...
export const knowledgeGraphSchema = z.object({
  triplets: z.array(tripletSchema).describe("Array of extracted triplets (subject-predicate-object)"),
  entity_types: z.array(z.string()).describe("List of entity types found in the text"),
});
